...
This product is a web-hosted AI that should serve to eliminate the necessity of the 'Game Master' (GM) role for the Table-Top Role-Playing Game (TTRPG) 'Lasers and Feelings' by taking on the responsibilities of said role, thus reducing the time and stress that would be required of an individual in planning and tracking a campaign session. With this, we aim to serve a number of existing or potential players with an emphasis on those who want to take a break from being the designated GM but whose players aren't willing to serve as a substitute, those who want to start a campaign but aren't confident enough in the rules or their improvisational abilities to try hosting the game, or those groups who can barely manage to schedule a session together let alone have someone plan anything substantial.
...
Given the nature of this product, some additional clarification and background on the subject matter should be provided. 'Lasers and Feelings' is a role-playing game that follows in the footsteps of the Old-School Renaissance (OSR) movement, focusing more on narrative storytelling rather than mechanics or simulation. In this, the full set of instructions for 'Lasers and Feelings' is contained within a single page, emphasizing its minimalist approach and leaving lots of room for interpretation and exploration by the GM and players. This open-endedness is in part the reason for selecting 'Lasers and Feelings' as the system which the GM-PC will operate within; it allows for full utilization of generative AI's 'creative output' while minimizing the hard constraints and parsing of player action as would be required by a larger rule set.
...
- **MVP:** Johnathan is about to finish his turn but decides to clean the ceiling fans thirty feet up in the air. Because there is a risk of him falling or damaging the fan in the process, he must roll dice to see what the result is. He rolls two failures, causing the fan to fall on the new shipment of oxygen canisters, meaning that their oxygen supplies will only last for one week. 
...
Recognizing this product is not created in isolation, there are several other products and services which are either direct competitors within the field of artificial TTRPG GMs or serve as inspiration with regard to specific components or mechanics. Highlighting and analyzing such products allows for good faith emulation as well as clarity in where this product may differentiate itself and develop its own identity. Below is a curated selection of works for the purpose of analyzing, comparing, and contrasting:

### Pokémon FireRed

- 'Pokémon FireRed'<sup>[1]</sup> is vastly different than our product, but one feature from that game has inspired part of our design. These games have a feature where when the player launches the game, it shows a brief summary of a couple of events/actions that the player took part in the last time they played the game. These games show text along with a small recording of the player at the place of the events described. This is similar to the summary feature that will be in our product, since both will describe to the players a summary of the key events that took place in the last session they played. There are definitely some differences however, as we will be using an AI model to summarize the key events since there is a large focus on the AI Game Master in our product. There will also be no visual component alongside the text descriptions, as visual displays of the adventure are less important given how TTRPGs are fundamentally text-based experience, and thus visuals do not lie within the proposed design of our product.

### The Devils and the Details

- 'The Devils and the Details' is one of the games featured in 'The Jackbox Party Pack 7'<sup>[2]</sup>, having players take on the roles of various family members to work either together or individually to complete tasks and raise a collective team score above a threshold. This game shares several superficial elements with our project in that they both have a primary screen where the team status is shown and utilize individual devices on which players can perform actions. However, the actual gameplay and actions performed are radically different, with 'The Devils and the Details' playing as a series of mini-games and our project serving as means for text input and action-order resolution. With this, one aspect of 'The Devils and the Details' we do want to emulate is the emergency meter; in that game, players can perform selfish actions which give a lot of individual points but lower the team score and raise the emergency rating. Upon the emergency rating reaching a critical point, the game switches to a salvage point where everyone is forced to fix a 'family emergency' such as the basement flooding. While this exact idea will not work for Lasers and Feelings as the players are entirely cooperative, having an emergency meter displayed on the main screen along with encroaching danger lights for the ship or general team status would help to add tension to a series of bad rolls, lead to team discussion and interplay, and depending on what parameters the players create the session with, lead to a game-over given that Lasers and Feelings does not specify an actual endpoint.

### Clash Royale

- The 'Clash Royale/<sup>[3]</sup> emote system is similar to the reaction system we plan to have in our product. Both systems allow the player to send expressive, animated reactions during gameplay. 'Clash Royale' has a large variety of emotes the player can display; however, we do not plan to have a large selection in our implementation of the system at this point. Instead, our system will be more specific to showing if the player is for, against, or indifferent about the decisions of the other player. This makes sense for our product since it is designed for the players to be in the same room as each other, so we will not lose anything by having less emotes as the players can still express themselves in-person.
